...
class _11_24_CustomExceptionTest {
	public static int readIntFromConsole() {
		...
		try { 
			...
			throw new _11_23_InvalidInputException("Invalid integer input typed in console", nsee);
		} catch(Exception e) {
	...
	public static void main(String [] args) {
		...
		} catch(_11_23_InvalidInputException iie) {
