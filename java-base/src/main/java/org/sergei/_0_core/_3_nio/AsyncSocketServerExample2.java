...
public class AsyncSocketServerExample2 {
    ...
    private void startServer() throws IOException, ExecutionException, InterruptedException {
        ...
        System.out.println("Server2 channel bound to port: " + listenAddress.getPort() );
        ...
        serverChannel.accept(null, new CompletionHandler<AsynchronousSocketChannel, Void>() {
            ...
            public void completed(AsynchronousSocketChannel ch, Void attachment) {
                ...
                // Greet the client
                ch.write( ByteBuffer.wrap( "Hello, I am Echo Server2 2020, let's have an engaging conversation!\n".getBytes() ) );
